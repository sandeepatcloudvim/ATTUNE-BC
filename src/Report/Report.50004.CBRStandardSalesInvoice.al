report 50004 "CBR Standard Sales Invoice"
{
    RDLCLayout = './CBRStandardSalesInvoice.rdlc';
    WordLayout = './CBRStandardSalesInvoice.docx';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(TaxRegisterNo; TaxRegisterNo)
            {
            ...
            begin
                ...
                if recCustomer.Get(Header."Sell-to Customer No.") then begin
                    TaxRegisterNo := recCustomer."VAT Registration No.";
                end;
